        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-white border-0 py-3 px-4">
                    <h4 class="mb-0 fw-bold text-dark"><i class="fa-solid fa-plus text-primary me-2"></i>Thêm Khoa Mới</h4>
                </div>
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('admin.khoa.store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" id="TenKhoa" name="TenKhoa" value="{{ old('TenKhoa') }}" class="form-control form-control-lg shadow-sm rounded-3 bg-light border-0 px-3" placeholder="Nhập tên khoa (VD: Khoa Công nghệ Thông tin)..." required />
                            @error('TenKhoa')
                        ...
                        <div class="form-group mb-5">
                            ...
                            <textarea id="MoTa" name="MoTa" class="form-control shadow-sm rounded-3 bg-light border-0 px-3 py-2" rows="5" placeholder="Nhập mô tả cho khoa này...">{{ old('MoTa') }}</textarea>
                            @error('MoTa')
                                <span class="text-danger small fw-bold mt-1 d-block">{{ $message }}</span>
                            @enderror
                        </div>
