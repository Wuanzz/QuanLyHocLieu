...
// ==========================================
// PUBLIC AREA (Khu vực mở cho khách vãng lai)
// ==========================================
Route::get('/', [HomeController::class, 'index'])->name('home');

// Mở các API để hỗ trợ fetch dữ liệu form động
...
// ==========================================
// PRIVATE USER AREA (Khu vực bắt buộc ĐĂNG NHẬP)
// ==========================================
Route::middleware(['auth'])->group(function () {
    
    // --- KHÔNG GIAN KHO TÀI LIỆU ---
    ...
    Route::post('/ho-so/doi-mat-khau', [HoSoController::class, 'xuLyDoiMatKhau'])->name('hoso.xuLyDoiMatKhau');
